...
export default function HomePage(): JSX.Element {
  return (
    <div className="space-y-10">
      <section className="grid gap-8 overflow-hidden rounded-2xl border bg-card/90 p-6 shadow-sm sm:p-10 lg:grid-cols-[1.2fr_0.8fr]">
        <div>
          <p className="text-xs uppercase tracking-[0.28em] text-primary">RSH Брендовый Маркет</p>
          <h1
            className="mt-3 text-[2.75rem] leading-[0.9] tracking-[0.05em] sm:text-6xl"
