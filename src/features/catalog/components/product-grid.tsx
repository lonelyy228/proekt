      ...
      <article key={product.id} className="group rounded-xl border bg-card p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
        <div className="relative mb-4">
          <Link
            ...
            className="relative block aspect-square overflow-hidden rounded-lg border bg-[linear-gradient(140deg,rgba(8,8,8,0.12),rgba(255,255,255,0.72))]"
          >
            {product.imageUrl ? (
              <Image
          ...
          <WishlistToggleButton
            ...
            loginRedirectPath={`/product/${product.slug}`}
            compact
