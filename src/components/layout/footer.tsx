      ...
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-10 lg:grid-cols-[1.1fr_0.9fr_0.9fr]">
        <div className="space-y-4">
          ...
          <p className="text-xs leading-6 text-muted-foreground">
            Важно: для публичной продажи брендовых товаров необходимы подтвержденные поставщики, документы о происхождении товара и право на коммерческую реализацию соответствующих марок.
          </p>
        </div>
