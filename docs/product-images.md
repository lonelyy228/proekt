...
2. Лучше делать квадрат: `1200x1200` или `1600x1600`.
...
6. Открой `prisma/seed.ts`, найди товар по `slug` и укажи массив `images`:
...
8. Открой карточку товара. На странице товара появятся 3 миниатюры и переключение картинок.
...
Страница товара берёт максимум 3 изображения. Если в seed добавить больше, лишние не будут показаны в галерее.
