...
6. Приложение. Готовые блоки для вставки диаграмм и иллюстраций

---

> Ниже собран единый текст дипломной работы. В местах, где требуются финальные изображения диаграмм и скриншоты, можно вставить подготовленные иллюстрации из draw.io и готовые изображения интерфейса.
